...
projects_ = OrderedDict([
    ('Ein-Blick-in-die-gemeinsame-Vergangenheit', {
        ...
        'number': '',
        'duration': '1. Oktober 2020 bis 31. Dezember 2021 (15 Monate)',
        'pi': 'Erzpriester OStR HS Prof. Dr. Nicolae Dura, Bischofsvikar der rumänisch-orthodoxen Kirche in Österreich',
        'members': ['Ioan Dorin Rus',
                    'Irina Dura-Niţu ',
        ...
        'sponsor': ['MA7'],
        'partners': None,
        'gallery': ['saguna.jpg', 'boeriu_ioan.jpg', 'cantacuzino_serban.jpg'],
        'description': """
        <p>
        Das MA 7-Projekt präsentiert Persönlichkeiten, Orte und besondere historische Ereignisse der Repräsentanz und des Engagements der orthodoxen Wiener RumänInnen. Tatsächlich reicht deren Geschichte und Präsenz in Österreich weit in das 17. Jahrhundert zurück. Die Zahl der rumänisch-orthodoxen Gläubigen war Mitte des 19. Jahrhunderts beeindruckend: eine Million in Ungarn und im Banat, zwei Millionen in Siebenbürgen und in der Bukowina. Es war also eine ethnische und religiöse Gruppe, die nicht übersehen werden konnte. Zu Beginn des Ersten Weltkrieges hatte Österreich-Ungarn 53 Millionen Einwohner, davon waren 7% RumänInnen. Im Jahr 1910 lebten 4.757 orthodoxe RumänInnen in Wien. Nicht nur für die drei Millionen RumänInnen unter der Herrschaft der Habsburger, sondern auch für alle anderen RumänInnen war Wien lange Zeit das wichtigste europäische Kulturzentrum. In der Denkschrift der rumänischen Gesellschaft in Wien aus dem Jahr 1910 wurde folgendes festgehalten: „Fast alle unsere Männer, die an der Spitze des Volkes stehen, haben ihre Studien in Wien beendet”.
Dieses Forschungsprojekt wird anhand biographischer Daten orthodoxer RumänInnen in Wien im Zeitraum von 235 Jahren (1683-1918) veranschaulichen, wie die Orthodoxen nach Wien migrierten und wie sich die orthodoxen Händler hier niederließen. Anhand von in österreichischen Archiven recherchierten Daten wird die Lebensgeschichte berühmter RumänInnen in Wien nachvollzogen, werden deren Wirkungsstätten lokalisiert und im <a href="https://orthodoxes-europa.at/geoportal">„Digitalen Geoportal der Geschichte der Orthodoxen in Österreich“</a> (Doz. Mag. Dr. Mihailo Popović, Projektleiter) eingebettet.
        </p>
        <p>
        ...
        <ol  type="a">
            <li>
            berühmte rumänische Persönlichkeiten aus Kunst und Literatur, die aus rumänischer, österreichischer und internationaler Perspektive von Bedeutung sind; Komponisten und Musiker
            </li>
            <li>
            rumänische Fürsten, Beamte (Parlamentarier; Generäle) und Kaufleute
            </li>
            <li>
            rumänische Persönlichkeiten, die von Bedeutung für die rumänische Geschichte sind.
            </li>
        </ol>
        <p>
 ...
 """
    ...
    ('Flucht-Gefangenschaft-Neubeginn-und-Widerstand', {
        ...
        'members': ['Peter Fraundorfer', 'Verena Demel',
                    'Sandra Wabnitz (ehrenamtlich)'],
        'institute': ['MT'],
        'sponsor': ['ZF'],
        'partners': ['AIT'],
        'gallery': ['lageplan.jpg', 'lager_oberhollabrunn.jpg',
...
<a href="http://www.zukunftsfonds-austria.at/projektinfo.php?pcode=P19-3804" target="_blank">http://www.zukunftsfonds-austria.at/projektinfo.php?pcode=P19-3804</a> </p>
 ...
 """
    ...
    ('Digitales-Geoportal-der-Geschichte-der-SerbInnen-in-Wien', {
        ...
        'sponsor': ['MA7'],
        'partners': ['AIT'],
        'gallery': ['sveti_sava.jpg', 'unterschrift_velimirovic.jpg',
                    'uros_predic.jpg'],
